function CardProductDisplay() {
    ...
    trthead.appendChild(thCategories);
    ...
    trtbody.appendChild(tdStock);
    trtbody.appendChild(tdCategories);
    trtbody.appendChild(tdAction);
    tdAction.appendChild(icons);
    icons.appendChild(IbxEdit);
    icons.appendChild(IbaxTrash);
